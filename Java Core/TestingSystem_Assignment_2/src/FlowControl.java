...
public class FlowControl {
	public static void main(String[] args) {
			...
			System.out.println("Nhân viên này là người hóng chuyện," + " tham gia tất cả các group");
		{
			...
			// Question 4:
			System.out.println(
					account1.position.name == "dev" ? "Nhân viên này là developer" : "Nhân viên này không phải dev");
			// SWITCH CASE
			// Question 5:
			int accountOfGroup1 = group1.accounts.length;
			switch (accountOfGroup1) {
			case 1:
			...
			for (int i = 0; i < departments.length; i++) {
				System.out.println("thông tin deparment " + (i + 1));
